...
Управление шариком происходит с помощью панели внизу. Если шарик упадет внизу,
то игрок теряет ожну жизнь (всего их три). Количество жизней отображается
вверху слева.
...
соответствующее сообщение. Нажмите по нему левой кнопкой мыши, чтобы вернутся
в игровое меню.
